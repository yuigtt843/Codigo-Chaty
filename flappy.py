...
images={
    "start": pygame.image.load("image/start.jpg"),
    "home": pygame.image.load("images/home.jpg"),
    "steal": pygame.image.load("images/steal.jpg"),
    "wake_up":pygame.image.load("images/wake_up.jpg"),
    "watch_series":pygame.image.load("images/watch_series.jpg"),
