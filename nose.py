...
image_paths = ["start", "home", "steal", "wake_up", "watch_series", "take_pill", "confident", 
               "cheat", "wrong_answer", "correct_answer", "tell_mother", "stay_silent", 
               "run_away", "be_honest"]

images = {name: load_and_scale_image(f"{name}.jpg", SCREEN_WIDTH, SCREEN_HEIGHT) for name in image_paths}
...
history = {
    ...
    "wake_up": {
        ...
        "choices": {"1": "watch_series", "2": "take_pill"}
    },
    "watch_series": {
    ...
    "take_pill": {
        ...
        "choices": {"1": "wrong_answer", "2": "correct_answer"}
    },
    "confident": {
    ...
    "cheat": {
        ...
        "choices": {"1": "run_away", "2": "be_honest"}
    },
    "wrong_answer": {
        ...
        "choices": {"1": "tell_mother", "2": "stay_silent"}
    },
    "correct_answer": {
...
def change_scene(key):
    ...
    if key in history[current_scene]["choices"]:
        current_scene = history[current_scene]["choices"][key]
    ...
    while running:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                change_scene(str(event.key - pygame.K_0))  
