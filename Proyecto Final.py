...
def masa_molar(atomo1, atomo2, elemento1, elemento2):
    ...
    print("La masa molar seria:", str(resultado)," ")
...
def Quimica():
    quimica=input("""Que operacion desea realizar
                  1. Calcular la Masa Molar
                  2. Conversion de moles a Gramos
                  3. Concentracion Molar en una solucion
                  4. Balance de Ecuacion
                                        : """)
    
    if quimica=="1":
        atomo1=input("Ingrese el numero de atomos de su primer elemento: ")
        atomo2=input("Ingrese el numero de atomos de su segundo elemento: ")
        elemento1=input("Ingrese el numero de atomos del siguiente elemento: ")
        elemento2=input("Ingrese el numero de atomos del segundo elemento: ")
